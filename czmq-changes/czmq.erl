...
zctx_set_maxsockets(Ctx, Val) when is_integer(Val) ->
    zctx_set_int(Ctx, ?ZCTX_SET_MAXSOCKETS, Val).
...
zsocket_set_linger(Sock, Backlog) ->
    sockopt_set_int(Sock, ?ZSOCKOPT_LINGER, Backlog).
